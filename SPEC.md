...
878 tests. Interface auditée en entier, en deux lots, `ui/` d'abord, puis la vue
...
| 2026-09-05 | **La colonne des agencements gardés se règle sur trois points.** ⚠️ **Le cadre vert dit ce qu'on regarde**, non ce qu'on a gardé : posé à la sauvegarde et laissé tel quel, il prétendait montrer l'agencement affiché alors que le curseur était parti ailleurs. Il suit désormais le cliché courant, reconnu par son **numéro d'itération et sa grille**, deux calculs pouvant passer par la même itération sans y ranger les mêmes cartes. ⚠️ **Un agencement que la timeline n'a plus s'ouvre dans une fenêtre à part**, zoomable, sous un avertissement ambre « L'agencement n'est plus dans la timeline » : le curseur ne bouge pas, le montrer au plus proche donnerait à voir autre chose que ce que la case promet. ⚠️ **La croix demande confirmation** : elle est à quelques pixels de la vignette, et ce qu'elle efface ne se retrouve pas, aucun calcul ne redonnant deux fois le même agencement |
